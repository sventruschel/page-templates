          ...
          <Footer
            ...
            onSave={() => {
              ...
              if (authProfile) {
                ...
                const formPrefab = newPrefab.structure[0].descendants[0].descendants[0].descendants[0].descendants[0].descendants[1].descendants[0].descendants[1].descendants[0]
                ...
                descendants: [
                    {
                        ...
                        options: [
                          ...
                          {
                            value: ['https://assets.bettyblocks.com/1e9019bb1c5c4af2ba799c2ee1761af0_assets/files/login-background'],
                                        ...
                                        descendants: [
                                          {
                                            ...
                                            descendants: [{
                                                ...
                                                options: [
                                                  ...
                                                  {
                                                    value: ['https://www.bettyblocks.com/hubfs/Betty_Blocks_December2018/Images/logo-red.svg'],
                                                    label: 'Source',
                                                    key: 'imageSource',
                                                    type: 'VARIABLE',
                                                    configuration: {
