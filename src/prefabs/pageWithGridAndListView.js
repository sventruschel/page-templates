      ...
      <>
        ...
        <Footer
          ...
          onSave={() => {
            ...
            if (modelId) {
              const dataList =
                prefabStructure[1].descendants[0].descendants[0].descendants[2].descendants[0].descendants[0];
              ...
              const dataGrid =
                prefabStructure[1].descendants[0].descendants[0].descendants[2].descendants[1].descendants[0];
