(() => ({
  ...
  beforeCreate: ({
    ...
    const [uspModelId, setUspModelId] = React.useState('');
    const [reviewModelId, setReviewModelId] = React.useState('');
    const [category, setCategory] = React.useState('');
    const [title, setTitle] = React.useState('');
    const [subTitle, setSubTitle] = React.useState('');
    const [shortDescription, setShortDescription] = React.useState('');
    const [imageProperty, setImageProperty] = React.useState('');
    const [uspName, setUspName] = React.useState('');
    const [originalPrice, setOriginalPrice] = React.useState('');
    const [sellingPrice, setSellingPrice] = React.useState('');
    const [tabOneContent, setTabOneContent] = React.useState('');
    ...
    const saveAnotherPage = () => {
      if (validate()) {
        ...
        const productIdProperty = data.model.properties.find(
          p => p.name === 'id',
        ).id;
        ...
        newPrefab.structure[0].descendants[0].descendants[1].descendants[0].options[0].value = [
          enrichVarObj(category),
        ];
        newPrefab.structure[0].descendants[0].descendants[1].descendants[1].options[0].value = [
          enrichVarObj(title),
        ];
        newPrefab.structure[0].descendants[0].descendants[1].descendants[2].options[0].value = [
          enrichVarObj(subTitle),
        ];
        newPrefab.structure[0].descendants[0].descendants[1].descendants[3].options[0].value = [
          enrichVarObj(shortDescription),
        ];
        newPrefab.structure[0].descendants[0].descendants[0].descendants[0].options[1].value = [
          enrichVarObj(imageProperty),
        ];
        newPrefab.structure[0].descendants[0].descendants[1].descendants[4].options[0].value = uspModelId;
        newPrefab.structure[0].descendants[0].descendants[1].descendants[4].descendants[0].descendants[1].options[0].value = [
          enrichVarObj(uspName),
        ];
        newPrefab.structure[0].descendants[0].descendants[1].descendants[5].options[0].value = [
          enrichVarObj(originalPrice),
        ];
        newPrefab.structure[0].descendants[0].descendants[1].descendants[6].options[0].value = [
          enrichVarObj(sellingPrice),
        ];
        newPrefab.structure[0].descendants[1].descendants[0].descendants[0].descendants[0].descendants[0].options[0].value = [
          enrichVarObj(tabOneContent),
        ];
        newPrefab.structure[0].descendants[1].descendants[0].descendants[0].descendants[1].descendants[0].options[0].value = reviewModelId;
        newPrefab.structure[0].descendants[1].descendants[0].descendants[0].descendants[1].descendants[0].descendants[0].options[0].value = [
          enrichVarObj(reviewTitle),
        ];
        newPrefab.structure[0].descendants[1].descendants[0].descendants[0].descendants[1].descendants[0].descendants[1].options[0].value = [
          enrichVarObj(reviewDescription),
        ];
        ...
        <Content>
          <Box direction="row">
            <Box direction="column" basis="1/2">
              ...
              <Field label="Product details tab content">
                <PropertySelector
                  modelId={modelId}
                  onChange={value => {
                    setTabOneContent(value);
                  }}
                  value={tabOneContent}
                />
              </Field>
            ...
            <Box direction="column" basis="1/2">
              <Heading size="medium">Product Review</Heading>
              <Field label="Review Model">
                <ModelSelector
                  onChange={value => {
                    setReviewModelId(value);
                  }}
                  value={reviewModelId}
                />
              </Field>
              ...
              <Field label="Review Description">
                <PropertySelector
                  modelId={reviewModelId}
                  onChange={value => {
              ...
              <Heading size="medium">General USPs</Heading>
              <Field label="USP Model">
                <ModelSelector
                  onChange={value => {
                    setUspModelId(value);
                  }}
