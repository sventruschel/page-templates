(() => ({
  ...
  beforeCreate: ({
    ...
    const interactions = [
      ...
      },
      {
        ...
        ref: {
          targetComponentId: '#deleteDialog',
          sourceComponentId: '#closeDeleteDialogBtn',
        },
        type: 'Custom',
      },
      {
        ...
        ref: {
          targetComponentId: '#deleteDialog',
          sourceComponentId: '#cancelDeleteDialogBtn',
        },
        type: 'Custom',
      },
    ];
  ...
  variables: [
    ...
    },
    {
      ...
      name: 'form_data_edit',
      ref: {
        id: '#customModelVariableIdEdit',
        endpointId: '#endpointIdEdit',
      },
      options: {
        modelId: '',
        ref: {
    ...
    {
      kind: 'object',
      name: 'form_object_edit',
      ref: {
        id: '#objectVariableIdEdit',
        endpointId: '#endpointIdEdit',
      },
      options: {
        modelId: '',
