        ...
        <Footer
          ...
          onSave={() => {
            ...
            if (modelId) {
              ...
              titleProperty.id && (dataGrid.descendants[0].descendants[1]
                .options[2].value = [enrichVarObj(titleProperty)]);
              subheaderProperty.id && (dataGrid.descendants[0].descendants[1]
                .options[3].value = [enrichVarObj(subheaderProperty)]);
              descriptionProperty.id && (dataGrid.descendants[0].descendants[2]
                .descendants[0].options[0].value = [enrichVarObj(descriptionProperty)]);
