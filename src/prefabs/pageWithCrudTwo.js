(() => ({
  name: 'Page With CRUD Data Table 2',
  description: 'This is a page which contains a datatable with CRUD sidebar',
  icon: 'DataTable',
  category: 'DATA',
  beforeCreate: ({
    close,
                              ...
                              },
                              {
                                ...
                                options: [
                                  ...
                                  },
                                  {
                                    ...
                                    label: 'Body text',
                                    key: 'bodyText',
                                    value: ['Record succesfully created'],
                                    configuration: {
                                      dependsOn: 'model',
                                    },
                                  },
                              ...
                              },
                              {
                                ...
                                options: [
                                  ...
                                  },
                                  {
                                    ...
                                    key: 'bodyText',
                                    value: [
                                      'Something went wrong while creating record',
                                    ],
                                    configuration: {
                                      dependsOn: 'model',
                                    },
                              ...
                              },
                              {
                                ...
                                options: [
                                  ...
                                  },
                                  {
                                    ...
                                    label: 'Body text',
                                    key: 'bodyText',
                                    value: ['Record succesfully updated'],
                                    configuration: {
                                      dependsOn: 'model',
                                    },
                                  },
                                ...
                                options: [
                                  {
                                    value: {
                                      modelId,
                                      ref: {
                                        customModelId: '#updatecustomModelId',
                                        actionId: '#updateActionId',
                                        variableId: '#updateCustomModelVariableId',
                                        objectVariableId:
                                          '#updateObjectVariableId',
                                      },
                                    },
                                    label: 'Action',
                                    key: 'formData',
                                            ...
                                            options: [
                                              {
                                                ...
                                                key: 'content',
                                                value: [
                                                  'To toggle the sidebar you have navigate to the highest parent component (Drawer) and click on Toggle visibility.  In this sidebar you find the "add user" and "edit user" forms.',
                                                ],
                                                configuration: {
                                                  as: 'MULTILINE',
                                                },
  ...
  interactions: [
    ...
    },
    {
      ...
      ref: {
        targetComponentId: '#createErrorAlert',
        sourceComponentId: '#createForm',
      },
      type: 'Custom',
    },
    ...
    },
    {
      ...
      ref: {
        targetComponentId: '#drawerSidebar',
        sourceComponentId: '#cancelCreateButton',
      },
      type: 'Custom',
    },
    {
