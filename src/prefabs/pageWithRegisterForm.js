        ...
        <>
          ...
          <Footer
            ...
            onSave={() => {
              ...
              if (modelId) {
                const formPrefab =
                  newPrefab.structure[0].descendants[0].descendants[0].descendants[0].descendants[0].descendants[1].descendants[0].descendants[2].descendants[0];
                                ...
                                descendants: [
                                  {
                                    ...
                                    options: [
                                      ...
                                      {
                                        value: ['https://via.placeholder.com/550x100/?text=[Insert logo here]'],
                                        label: 'Source',
                                        key: 'imageSource',
                                        type: 'VARIABLE',
                                        configuration: {
